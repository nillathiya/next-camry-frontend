...
const DepositHistory = () => {
  ...
  const addFundHistory = useAppSelector(selectAddFundHistory);
  ...
  const filteredTx = useMemo(() => {
    if (!debouncedFilterText) return addFundHistory;
    ...
    return addFundHistory.filter((tx: IFundTransaction) =>
      [
        filterCode(tx.uCode),
  ...
  }, [addFundHistory, debouncedFilterText]);
