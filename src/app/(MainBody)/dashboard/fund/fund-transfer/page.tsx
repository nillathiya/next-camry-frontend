...
const TransferComponent: React.FC = () => {
  ...
  const fundTransferWallets = useFundTransferWallets();
  ...
  }, [dispatch, walletSettings.length, userWallet, settingsLoading, userLoading]);
  ...
  return (
    <TransferContainer theme={darkMode ? "dark" : "light"}>
      <TransferForm onSubmit={handleSubmit(onSubmit)}>
        ...
        <TransferButton type="submit" disabled={isSubmitting || !isValidUsername}>
