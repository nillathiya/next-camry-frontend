...
const DepositHistory = () => {
  ...
  useEffect(() => {
    ...
    fetchWithdrwalHistory();
  }, []);

  const filteredTx = useMemo(() => {
    if (!debouncedFilterText) return fundWithdrwalHistory;
    ...
    return fundWithdrwalHistory.filter((tx: IFundTransaction) =>
      [
        filterCode(tx.uCode),
  ...
  }, [fundWithdrwalHistory, debouncedFilterText]);
